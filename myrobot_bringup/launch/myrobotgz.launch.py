...
def generate_launch_description():
    ...
    # Nếu file lua của bạn nằm ở package "navigation" thì đổi package này thành "navigation".
    # Nếu vẫn nằm ở "myrobot_cartographer_slam" thì giữ nguyên như dưới.
    ...
    # Khởi động SLAM sau khi controller + tf_relay đã có thời gian lên đủ
    r1 = Node(
    ...
    return LaunchDescription([
        ...
        *robot3,
        ...
        # relay lên sau khi mecanum controller của cả 3 robot đã lên
        TimerAction(period=48.0, actions=[tf_relay]),

        # cartographer lên sau relay để tránh race condition TF
        TimerAction(period=52.0, actions=[r1, r1_grid]),
        TimerAction(period=54.0, actions=[r2, r2_grid]),
        TimerAction(period=56.0, actions=[r3, r3_grid]),
    ])